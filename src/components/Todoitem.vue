...
<template>
  <div :class="{ todo_item: true, completed: todo.completed }">
    <div class="info" v-if="todo.isEditing">
      <input class="input-edit" type="text" v-model="tempTitle" />
      <textarea class="textarea-edit" v-model="tempDescription"> </textarea>
      <input class="input-edit" type="date" v-model="tempDate" />
  ...
  <ConfirmModal v-if="isModalVisible" @confirm="confirmUpdate" @cancel="cancelUpdate" />
</template>
